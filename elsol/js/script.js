...
function renderizarProductos() {
  ...
  productos.forEach((producto, index) => {
    ...
    html += `<tr>
              ...
              <td>${producto.unMedida}</td>
              <td style="text-align:right;">${cantidadFinal}</td>
...
function cargarModalEditarProducto(id) {
  ...
  if (producto.codUM == 3) {
    modalHtml += `
            <div class="col-lg-6 col-mb-6 col-sm-12">
              ...
              <input type="text" id="act-cantidad" placeholder="Cantidad" class="form-control" value="${producto.cantidad}" />
            </div>
            <div class="col-lg-2 col-mb-2 col-sm-12">
              <label for="act-espesor">Espesor</label>
              <input type="text" id="act-espesor" placeholder="Espesor" class="form-control" value="${producto.espesor}" />
            </div>
            <div class="col-lg-2 col-mb-2 col-sm-12">
              <label for="act-ancho">Ancho</label>
              <input type="text" id="act-ancho" placeholder="Ancho" class="form-control" value="${producto.ancho}" />
            </div>
            <div class="col-lg-2 col-mb-2 col-sm-12">
              <label for="act-largo">Largo</label>
              <input type="text" id="act-largo" placeholder="Largo" class="form-control" value="${producto.largo}" />
            </div>`;
  } else {
    modalHtml += `
            <div class="col-lg-6 col-mb-6 col-sm-12">
  ...
  modalHtml += `
            <div class="col-lg-6 col-mb-6 col-sm-12">
              ...
              <input type="text" id="act-precio" placeholder="Precio" class="form-control" value="${producto.precio}" />
            </div>
          </div>
        </div>
