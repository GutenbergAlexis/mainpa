...
<head>
    ...
    <title>Detalle diario - Mainpasoft</title>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="#">Detalle diario</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Detalle diario</h1>
					</div>
<?php
...
?>
					<div class="panel-body col-lg-3 col-mb-6 col-sm-12">
						<label for="fecha-detalle-diario">Fecha</label>
						<input class="form-control datepicker" id="fecha-detalle-diario" name="fecha-detalle-diario" data-provide="datepicker-inline" />
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="buscarReporteDetalleDiario()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen</h4>
						<div id="reporte-detalle-diario"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<form action="../../ajax/reportes/generar/generarReporteDetalleDiario.php" method="post">
							<input type="hidden" id="rep-fecha-detalle-diario" name="rep-fecha-detalle-diario" />
