...
?>
					<div class="panel-body col-lg-3 col-mb-6 col-sm-12">
						...
						<select class="form-control selectpicker" id="banco" name="banco" data-live-search="true" title="-- seleccionar --">
							<?php 
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="leerEgresosBancos()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de pagos a bancos</h4>
						<div id="egresos-bancos"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#mod-agregar-egresos-bancos" title="agregar">Agregar</button>
					</div>
<?php
		} 
		else 
...
?>
	...
	<!-- MODAL AGREGAR EGRESOS BANCOS -->
	<div class="modal fade" id="mod-agregar-egresos-bancos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
	
	<!-- MODAL CARGAR EGRESOS BANCOS -->
	<div class="modal fade" id="mod-cargar-egresos-bancos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
