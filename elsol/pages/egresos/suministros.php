...
<head>
    ...
    <title>Suministros - Mainpasoft</title>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="#">Suministros</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Suministros</h1>
					</div>
<?php
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="leerEgresosSuministros()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de pagos de suministros</h4>
						<div id="egresos-suministros"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#mod-agregar-egresos-suministros" title="agregar">Agregar</button>
					</div>
<?php
		} 
		else 
...
?>
	...
	<!-- MODAL AGREGAR EGRESOS SUMINISTROS -->
	<div class="modal fade" id="mod-agregar-egresos-suministros" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
	
	<!-- MODAL CARGAR EGRESOS SUMINISTROS -->
	<div class="modal fade" id="mod-cargar-egresos-suministros" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
