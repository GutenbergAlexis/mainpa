			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<th class="tabla-cabecera" width="45%">Producto</th>
						<th class="tabla-cabecera" width="10%">Un. medida</th>
						<th class="tabla-cabecera" width="10%">Cantidad</th>
						<th class="tabla-cabecera" width="10%">Precio unit.</th>
						<th class="tabla-cabecera" width="10%">Precio total</th>
