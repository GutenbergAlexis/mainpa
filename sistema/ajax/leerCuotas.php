...
?>
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						<th class="tabla-cabecera" width="10%">N°</th>
						<th class="tabla-cabecera" width="35%">Fecha</th>
						<th class="tabla-cabecera" width="30%">Monto</th>
						<th class="tabla-cabecera" width="25%">&nbsp;</th>
					</tr>
				</thead>
				<tbody>
<?php
