...
<head>
    ...
    <title>Otros egresos - Mainpasoft</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Otros egresos</h1>
					</div>
<?php
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="leerOtrosEgresos()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de otros egresos</h4>
						<div id="egresos-otros"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#mod-agregar-otros-egresos" title="agregar">Agregar</button>
					</div>
<?php
		} 
		else 
...
?>
	...
	<!-- MODAL AGREGAR OTROS EGRESOS -->
	<div class="modal fade" id="mod-agregar-otros-egresos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
	
	<!-- MODAL CARGAR OTROS EGRESOS -->
	<div class="modal fade" id="mod-cargar-otros-egresos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
