...
<head>
    ...
    <title>Servicios - Mainpasoft</title>
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="leerEgresosServicios()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de pagos de servicios</h4>
						<div id="egresos-servicios"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-success" data-toggle="modal" data-target="#mod-agregar-egresos-servicios" title="agregar">Agregar</button>
					</div>
<?php
		} 
		else 
...
?>
	...
	<!-- MODAL AGREGAR EGRESOS SERVICIOS -->
	<div class="modal fade" id="mod-agregar-egresos-servicios" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
	
	<!-- MODAL CARGAR EGRESOS SERVICIOS -->
	<div class="modal fade" id="mod-cargar-egresos-servicios" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
