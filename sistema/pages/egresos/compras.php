...
<head>
    ...
    <title>Compras - Mainpasoft</title>
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="leerCompras()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						...
						<form action="agregar-compra.php">
