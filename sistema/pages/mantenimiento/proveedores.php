...
<head>
    ...
    <title>Proveedores - Mainpasoft</title>
...
?>
					...
					<div class="modal-body">
						<div class="panel-body">
							...
							<div class="col-lg-6 col-mb-12 col-sm-12">
								...
								<input class="form-control" type="text" id="ruc" name="ruc" placeholder="RUC" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-12 col-mb-12 col-sm-12">
								<label for="razon-social">Razon social</label>
								<input class="form-control" type="text" id="razon-social" name="razon-social" placeholder="Razón social" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-12 col-mb-12 col-sm-12">
							...
							<div class="col-lg-12 col-mb-12 col-sm-12">
								...
								<input class="form-control" type="text" id="contacto" name="contacto" placeholder="Contacto" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
							...
							<div class="col-lg-6 col-mb-12 col-sm-12">
								...
								<input class="form-control" type="text" id="correo" name="correo" placeholder="Correo" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
						<button type="button" class="btn btn-primary" onclick="guardarProveedor();" title="guardar">Guardar</button>
					</div>
				</form>
			</div>
		</div>
	...
	<!-- MODAL ACTUALIZAR -->
	<div class="modal fade" id="mod-actualizar-proveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
    <!-- jQuery -->
