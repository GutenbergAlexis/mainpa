...
<head>
    ...
    <title>Clientes - Mainpasoft</title>
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<div id="clientes" class="centrar"></div>
					</div>
<?php
		} 
		else 
...
?>
					...
					<div class="modal-body">
						<div class="panel-body">
							...
							<div class="col-lg-6 col-mb-12 col-sm-12">
								...
								<select class="form-control selectpicker" id="agr-tipo-documento" name="agr-tipo-documento" data-live-search="true" title="-- seleccionar --" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" >
									<?php 
							...
							<div class="col-lg-6 col-mb-12 col-sm-12">
								...
								<input class="form-control" type="text" id="agr-numero-documento" name="agr-numero-documento" placeholder="Número de documento" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-primer-nombre">Primer nombre/Razón social</label>
								<input class="form-control" type="text" id="agr-primer-nombre" name="agr-primer-nombre" placeholder="Primer nombre/Razón social" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-segundo-nombre">Segundo nombre</label>
								<input class="form-control" type="text" id="agr-segundo-nombre" name="agr-segundo-nombre" placeholder="Segundo nombre" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-primer-apellido">Primer apellido</label>
								<input class="form-control" type="text" id="agr-primer-apellido" name="agr-primer-apellido" placeholder="Primer apellido" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-segundo-apellido">Segundo apellido</label>
								<input class="form-control" type="text" id="agr-segundo-apellido" name="agr-segundo-apellido" placeholder="Segundo apellido" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-12 col-mb-12 col-sm-12">
								<label for="agr-direccion">Dirección</label>
								<input class="form-control" type="text" id="agr-direccion" name="agr-direccion" placeholder="Dirección" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-12 col-mb-12 col-sm-12">
								<label for="agr-contacto">Contacto</label>
								<input class="form-control" type="text" id="agr-contacto" name="agr-contacto" placeholder="Contacto" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-telefono">Teléfono</label>
								<input class="form-control" type="text" id="agr-telefono" name="agr-telefono" placeholder="Teléfono" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-6 col-mb-12 col-sm-12">
								<label for="agr-celular">Celular</label>
								<input class="form-control" type="text" id="agr-celular" name="agr-celular" placeholder="Celular" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
							<div class="col-lg-12 col-mb-12 col-sm-12">
								<label for="agr-correo">Correo electrónico</label>
								<input class="form-control" type="text" id="agr-correo" name="agr-correo" placeholder="Correo electrónico" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" />
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
						<button type="button" class="btn btn-primary" onclick="guardarCliente();" title="guardar">Guardar</button>
					</div>
				</form>
			</div>
		</div>
	...
	<!-- MODAL ACTUALIZAR -->
	<div class="modal fade" id="mod-actualizar-cliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
