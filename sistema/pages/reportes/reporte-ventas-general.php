...
<head>
    ...
    <title>Reporte de ventas general - Mainpasoft</title>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="#">Reporte de ventas general</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="reporte-ingresos-mensual.php">Reporte de ingresos mensual</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Reporte de ventas general</h1>
					</div>
<?php
...
?>
					<div class="panel-body col-lg-3 col-mb-6 col-sm-12">
						<label for="tip-comprobante">Tipo de comprobante</label>
						<select class="form-control selectpicker" id="tip-comprobante" name="tip-comprobante" data-live-search="true" title="-- seleccionar --">
							<?php 
								$query = 'SELECT * FROM parametros WHERE padre = 8 ORDER BY codigo ASC';
								$result = mysqli_query($con, $query);
								while ($rows = mysqli_fetch_assoc($result)) 
								{
							?>
									<option value='<?php echo $rows['id']; ?>' data-tokens='<?php echo utf8_encode($rows['codigo'].$rows['codigo']); ?>'><?php echo utf8_encode($rows['codigo'].' - '.$rows['descripcion']); ?></option>
							<?php 
								}
							?>
						</select>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="buscarReporteVentasGeneral()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de ventas general</h4>
						<div id="reporte-ventas-general"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<form action="../../ajax/reportes/generar/generarReporteVentasGeneral.php" method="post">
							<input type="hidden" id="rep-tipo-comprobante" name="rep-tipo-comprobante" />
							<input type="hidden" id="rep-fecha-desde" name="rep-fecha-desde" />
							<input type="hidden" id="rep-fecha-hasta" name="rep-fecha-hasta" />
...
?>
	...
	<!-- MODAL CARGAR COMPRA -->
	<div class="modal fade" id="mod-cargar-compra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	</div>
