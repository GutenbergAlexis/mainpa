...
<head>
    ...
    <title>Reporte de compras por producto - Mainpasoft</title>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="#">Reporte de compras por producto</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Reporte de compras por producto</h1>
					</div>
<?php
...
?>
					...
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<button type="button" class="btn btn-default" data-toggle="modal" onclick="buscarReporteComprasProducto()" title="buscar"><i class="fa fa-search"></i> Buscar</button>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<h4>Resumen de compras por producto</h4>
						<div id="reporte-compras-producto"></div>
					</div>
					<div class="panel-body col-lg-12 col-mb-12 col-sm-12">
						<form action="../../ajax/reportes/generar/generarReporteComprasProducto.php" method="post">
							<input type="hidden" id="rep-proveedor" name="rep-proveedor" />
